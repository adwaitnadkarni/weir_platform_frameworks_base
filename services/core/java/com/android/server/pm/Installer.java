...
public final class Installer extends SystemService {
    ...
    public int createUserDataWeir(String name, int uid, int userId, String seinfo, String weirinfo) {
        StringBuilder builder = new StringBuilder("mkuserdataweir");
        builder.append(' ');
        builder.append(name);
        builder.append(' ');
        builder.append(uid);
        ...
        builder.append(seinfo != null ? seinfo : "!");
        builder.append(' ');
        builder.append(weirinfo != null ? weirinfo : "!");
        return mInstaller.execute(builder.toString());
    }
