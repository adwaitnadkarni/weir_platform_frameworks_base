...
public class WeirDomainSocketInterface_DNS implements Runnable {

	public static final String LOCALSOCKET_INTERFACE_NAME = "WEIR_DNS";
	private static final String TAG = "WEIRDomainSocketInterfaceDNS";
	private LocalServerSocket socket = null;
	private WeirManagerService mService;
	public WeirDomainSocketInterface_DNS(WeirManagerService weir) {
		mService = weir;
	}
