...
final class ActivityRecord {
    ...
    //Weir type
    private HashSet<Long> secrecyLabel = new HashSet<Long>();

    //get and set for secrecyLabel
    public HashSet<Long> getSecrecyLabel(){
	return this.secrecyLabel;
    }
    public void setSecrecyLabel(HashSet<Long> secrecyLabel){
	...
	//System.out.println("WEIR_DEBUG: in reportFullyDrawnLocked, starts.");
	...
	//System.out.println("WEIR_DEBUG: in reportFullyDrawnLocked, ends.");
    }
	...
	//System.out.println("WEIR_DEBUG: in windowsDrawn, starts.");
	...
	//System.out.println("WEIR_DEBUG: in windowsDrawn, ends.");
    }
