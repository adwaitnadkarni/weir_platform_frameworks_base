...
class AppWindowToken extends WindowToken {
	...
	//System.out.println("WEIR_DEBUG: in updateReportedVisibility, starts.");
        if (appToken == null) {
            return;
        }
		...
		//System.out.println("WEIR_DEBUG: in updateReportedVisibility for "+this);
	...
	//System.out.println("WEIR_DEBUG: in updateReportedVisibility, ends.");
    }
