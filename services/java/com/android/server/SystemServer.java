...
public final class SystemServer {
    ...
    private WeirManagerService mWeirManagerService;
	...
	// Weir Manager Service needs to be started early
        mWeirManagerService = mSystemServiceManager.startService(WeirManagerService.class);
	...
	try {
            // TODO: use boot phase
            mWeirManagerService.systemReady(mActivityManagerService.getAppOpsService());
        } catch (Throwable e) {
            reportWtf("making Weir Manager Service ready", e);
        }
