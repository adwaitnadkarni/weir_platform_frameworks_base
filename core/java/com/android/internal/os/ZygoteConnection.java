...
class ZygoteConnection {
    ...
    boolean runOnce() throws ZygoteInit.MethodAndArgsCaller {
	    ...
	    //WEIR: Create new calues for WEIR
            pid = Zygote.forkAndSpecialize(parsedArgs.uid, parsedArgs.gid, parsedArgs.gids,
                    parsedArgs.debugFlags, rlimits, parsedArgs.mountExternal, parsedArgs.seInfo,
                    parsedArgs.niceName, fdsToClose, parsedArgs.instructionSet,
                    parsedArgs.appDataDir, parsedArgs.weirPrefix, parsedArgs.weirExternalDir);
	...
	/**
	 * The weir mount dir prefix. Actually a postfix, but we need a
	 * systemwide naming change for that. May be null, when the non-secret
	 * instance is being started.
	 */
	String weirPrefix;

	/**
	 * The weir mount external dir postfix. May be null, when the non-secret
	 * instance is being started.
	 */
	String weirExternalDir;
        ...
        private void parseArgs(String args[])
            ...
            for ( /* curArg */ ; curArg < args.length; curArg++) {
                ...
                } else if (arg.startsWith("--weir_prefix=")) {
		    weirPrefix = arg.substring(arg.indexOf('=') + 1);
		} else if (arg.startsWith("--weir_external_dir=")) {
		    weirExternalDir = arg.substring(arg.indexOf('=') + 1);
		}
		else {
                    break;
                }
