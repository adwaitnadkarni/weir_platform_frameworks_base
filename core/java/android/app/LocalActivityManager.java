...
public class LocalActivityManager {
    ...
    private void moveToState(LocalActivityRecord r, int desiredState) {
	    ...
	    //System.out.println("WEIR_DEBUG: moveToState, calling startActivityNow for r");
            r.activity = mActivityThread.startActivityNow(
                    mParent, r.id, r.intent, r.activityInfo, r, r.instanceState, instance);
            if (r.activity == null) {
                return;
            }
	    //System.out.println("WEIR_DEBUG: moveToState, getting window for r");
            r.window = r.activity.getWindow();
	    //System.out.println("WEIR_DEBUG: moveToState, window "+r.window+" obtained for r");
