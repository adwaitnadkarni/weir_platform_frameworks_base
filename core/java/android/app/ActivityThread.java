...
public final class ActivityThread {
    ...
    private class ApplicationThread extends ApplicationThreadNative {
        ...
        public final void scheduleLaunchActivity(Intent intent, IBinder token, int ident,
                ...
                ProfilerInfo profilerInfo) {
	    //System.out.println("WEIR_DEBUG: scheduleLaunchActivity for activityInfo "+info+" starts.");
	    ...
	    //System.out.println("WEIR_DEBUG: scheduleLaunchActivity for activityInfo "+info+" ends.");
        }
    ...
    private Activity performLaunchActivity(ActivityClientRecord r, Intent customIntent) {
		...
		//System.out.println("WEIR_DEBUG: performStart returned in performActivityLaunch.. for client "+r);
                if (!r.activity.mFinished) {
                    if (r.isPersistable()) {
		    ...
		    //System.out.println("WEIR_DEBUG: postCreate returned in performActivityLaunch.. for client "+r);
                }
            }
            r.paused = true;
    ...
    private void installContentProviders(
	    ...
	    //WEIR: DEBUG: Log this
	    //System.out.println("WEIR_DEBUG: installContentProviders, called for "+cpi+", myPid:"+android.os.Process.myPid());
            ...
            if (cph != null) {
                ...
                results.add(cph);
		//WEIR_DEBUG
		//System.out.println("WEIR_DEBUG: installContentProviders, adding cph "+cph+", myPid:"+android.os.Process.myPid());
            } else {
		//WEIR: DEBUG: Log this
		//System.out.println("WEIR_DEBUG: installContentProviders, cph is null for cpi"+cpi+" myPid:"+android.os.Process.myPid());
	    }
        }
    ...
    public final IContentProvider acquireExistingProvider(
	    ...
	    //WEIR: TODO: Check the provider's label here. Return an existing
	    //provider only if it has a compatible label.
	...
	//WEIR: DEBUG: Log this
	//System.out.println("WEIR_DEBUG: installProvider, called for "+info+", myPid:"+android.os.Process.myPid());
        ...
        if (holder == null || holder.provider == null) {
		    ...
		    //WEIR: DEBUG: Log this
		    //System.out.println("WEIR_DEBUG: installProvider, failed to instantiate class for "+info+", myPid:"+android.os.Process.myPid());
                    return null;
                }
	    ...
	    //WEIR: DEBUG: Log this
	    //System.out.println("WEIR_DEBUG: installProvider, holder and holder.provider are not null for "+info+", myPid:"+android.os.Process.myPid());
	...
	//WEIR: DEBUG: Log this
	//System.out.println("WEIR_DEBUG: installProvider, assigned provider for "+info+", myPid:"+android.os.Process.myPid());
